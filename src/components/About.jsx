    ...
    <section className="w-full py-12 md:py-24 lg:py-32">
      <div className="container px-4 md:px-6">
        <div className="grid gap-6 lg:grid-cols-2 lg:gap-10">
          ...
          <img
            src="https://rknrfaylgopbmsntqidn.supabase.co/storage/v1/object/sign/hero-image/bg.jpg?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJoZXJvLWltYWdlL2JnLmpwZyIsImlhdCI6MTcyNTQ1MjY5NSwiZXhwIjoxNzU2OTg4Njk1fQ.0a_JRPUjcTeOEC85vwHEGxH2H8ZJroH0_lF3xVO97oQ&t=2024-09-04T12%3A24%3A56.991Z"
            alt="About Us"
