      ...
      <section id="home" className="w-full py-12 md:py-24 lg:py-32 pt-16">
        <div className="container px-4 md:px-6">
          <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
            <img
              src="https://rknrfaylgopbmsntqidn.supabase.co/storage/v1/object/sign/hero-image/cakehero.jpg?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJoZXJvLWltYWdlL2Nha2VoZXJvLmpwZyIsImlhdCI6MTcyNTExMjMwMywiZXhwIjoxNzU2NjQ4MzAzfQ.K1IK_kO6u59-m2uRsSv1Z61FhekzddL1U3xfbGNmhNM&t=2024-08-31T13%3A51%3A44.284Z"
              alt="Hero Cake"
