    ...
    <section id="flavors" className="w-full py-12 md:py-24 lg:py-32 bg-muted">
      <div className="container px-4 md:px-6">
        ...
        <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-2 lg:gap-12">
          <img
            src="https://rknrfaylgopbmsntqidn.supabase.co/storage/v1/object/sign/hero-image/flavour_cake.jpg?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJoZXJvLWltYWdlL2ZsYXZvdXJfY2FrZS5qcGciLCJpYXQiOjE3MjUxMTI0NTUsImV4cCI6MTc1NjY0ODQ1NX0.XSkYIHZhgJzZskNdcIqky_2zIEveS87QDWfdeB_YaLY&t=2024-08-31T13%3A54%3A15.928Z"
            alt="Cake Flavors"
